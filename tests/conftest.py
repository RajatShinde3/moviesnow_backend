...
- Isolates state per test run (namespace)
- Exposes a redis_client fixture and an opt-in ratelimit_on fixture
"""
...
# Usage: def test_something_rate_limited(ratelimit_on, async_client): ...
# ─────────────────────────────────────────────────────────────────────────────
@pytest.fixture()
